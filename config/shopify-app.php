...
write_order_edits'
    ...
    |
    */
    'shop_auth_provider' => env('SHOPIFY_SHOP_AUTH_PROVIDER', ''),
...
write_order_edits'
    ...
    */
    ...
    'api_redirect' => env('SHOPIFY_API_REDIRECT', '/api/index/shopify/authenticate'),
...
//        'orders/partially_fulfilled',
    ...
    */
    ...
    'table_names' => [
        ...
        */
        'charges' => 'dsp_shopify_charges',

        /*
        * The table name for Plan model.
        */
        'plans'   => 'dsp_shopify_plans',
    ]
];
