...
namespace App\Services\PlatformShop\Platform\Tiktok;
...
class TiktokService extends PlatformShopAbstract implements PlatformShopInterface
{

    protected string $platform = Platform::TIKTOK;
    ...
    {
        return 'https://services.us.tiktokshop.com/open/authorize?service_id=' . $this->request->getClientId();
    }
