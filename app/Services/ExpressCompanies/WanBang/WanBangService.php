 ...
 * 万邦速达
 */
class WanBangService extends Logistics
{
    ...
    protected string $channel = 'wanbang';
    ...
    {
        Log::channel('logistics')->info('wanBang-申请物流单号-1');
    ...
    public function loadConfig()
    {
        $config = CompanyDockingInfoModel::query()
            ->where('type', OrderDockingRecordModel::TYPE_WAN_BANG)
            ->first();
