...
class YuntuService extends Logistics
{
    ...
    protected string $channel = 'yuntu';
    ...
    protected function request(string $method, array $data)
    {
        ...
        try {
            ...
            Log::channel('logistics')->info('yuntu-订单云途物流对接失败', [
    ...
    protected function loadConfig()
    {
        $config = CompanyDockingInfoModel::query()
            ->where('type', OrderDockingRecordModel::TYPE_YUN_TU_LOGISTICS)
            ->first();
