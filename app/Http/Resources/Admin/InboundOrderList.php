...
class InboundOrderList extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            'inbound_quantity_sum' => (int)$this->items_sum_inbound_quantity,
            'inbound_type' => $this->inbound_type ?? 1,
            'inbound_type_name' => $this->inbound_type_name ?? '',
            'purchase' => $this->purchase ?? [],
            'stock_order_sn' => $this->stock_order_sn ?? '',
        ];
    }
}
