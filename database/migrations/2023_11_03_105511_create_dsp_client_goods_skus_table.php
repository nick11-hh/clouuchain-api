...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('dsp_client_goods_skus', function (Blueprint $table) {
            $table->id();
            ...
            $table->decimal('original_price', 10)->nullable()->comment('商品原价');
    ...
    {
        Schema::dropIfExists('dsp_client_goods_skus');
    }
};
